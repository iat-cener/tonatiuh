...
//!  TSceneNode class is the  class to store the different nodes that defines a Tonatiuh scene.
/*!
  TSceneNode class is a node to store several nodes as a part. These nodes defines a Tonatiuh scene
  -->   "light"
  -->   "transmisivity"
  -->   "childrenList"
*/
