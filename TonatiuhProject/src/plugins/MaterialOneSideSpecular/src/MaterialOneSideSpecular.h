...
private:
	...
	MaterialOneSideSpecular(const MaterialOneSideSpecular&) = delete;
	MaterialOneSideSpecular& operator=(const MaterialOneSideSpecular&) = delete;
