...
//!  TrackerHeliostatFactory is the class for creating TrackerHeliostat objects.
/*!
  TrackerHeliostatFactory class is a factory class to create instances of TrackerHeliostat.
*/

class TrackerHeliostatFactory: public TTrackerFactory
{
public:
	void Init() const;
