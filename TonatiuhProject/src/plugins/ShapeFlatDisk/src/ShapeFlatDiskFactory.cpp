 ...
 */
void ShapeFlatDiskFactory::Init() const
{
 ...
 * Returns shape icon.
 */
std::string ShapeFlatDiskFactory::TShapeIcon() const
{
	return std::string{ ":/icons/ShapeFlatDisk.png" };
}
...
DEFINE_PLUGIN( ShapeFlatDiskFactory, TShapeFactory, APP_VERSION )
