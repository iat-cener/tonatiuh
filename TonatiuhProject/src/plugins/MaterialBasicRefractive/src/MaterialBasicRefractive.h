...
private:
	...
	MaterialBasicRefractive(const MaterialBasicRefractive&) = delete;
	MaterialBasicRefractive& operator=(const MaterialBasicRefractive&) = delete;
...
private:
	...
	std::string m_reflectivityFrontLabel;
	std::string m_reflectivityBackLabel;
	std::string m_transmissivityFrontLabel;
	std::string m_transmissivityBackLabel;
	std::string m_nFrontLabel;
	std::string m_nBackLabel;
