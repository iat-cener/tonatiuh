...
#ifndef PHOTONMAPEXPORTTOBINARYFILEFACTORY_H_
#define PHOTONMAPEXPORTTOBINARYFILEFACTORY_H_
...
//!  PhotonMapExportToBinaryFileFactory is the class for creating objects that uses PhotonMapExportToBinaryFile to export photon map.
/*!
...
#endif /* PHOTONMAPEXPORTTOBINARYFILEFACTORY_H_ */
