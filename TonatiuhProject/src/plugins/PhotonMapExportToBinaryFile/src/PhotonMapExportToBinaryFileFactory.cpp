 ...
 */
std::string PhotonMapExportToBinaryFileFactory::PhotonMapExportTypName() const
{
	return ( "Binary_file" );
}
 ...
 */
std::unique_ptr<PhotonMapExportType> PhotonMapExportToBinaryFileFactory::CreatePhotonMapExportType( ) const
{
