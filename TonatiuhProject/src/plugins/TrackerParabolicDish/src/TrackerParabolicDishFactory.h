...
#ifndef TRACKERPARABOLICDISHFACTORY_H_
#define TRACKERPARABOLICDISHFACTORY_H_

#include "TrackerParabolicDish.h"
#include "TTrackerFactory.h"

//!  TrackerParabolicDishFactory is the class for creating TrackerParabolicDish objects.
/*!
