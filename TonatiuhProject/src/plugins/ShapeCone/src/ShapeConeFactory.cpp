 ...
 */
void ShapeConeFactory::Init() const
{
 ...
 */
std::shared_ptr< TShape > ShapeConeFactory::CreateTShape( ) const
{
	return ( std::dynamic_pointer_cast<TShape>( ShapeCone::CreateInstance() ) );
