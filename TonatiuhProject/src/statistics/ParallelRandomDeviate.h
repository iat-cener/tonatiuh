...
class STATISTICS_API ParallelRandomDeviate:  public RandomDeviate
{

public:
	ParallelRandomDeviate( RandomDeviate* rand, std::mutex* mutex, unsigned long arraySize = 100000 );
