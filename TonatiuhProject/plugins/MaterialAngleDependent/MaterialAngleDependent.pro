...
RESOURCES += src/MaterialAngleDependent.qrc

TARGET        = MaterialAngleDependent
 
CONFIG(debug, debug|release) {
	DESTDIR       = $$(TONATIUH_ROOT)/bin/debug/plugins/MaterialAngleDependent	
	unix {
	...
	DESTDIR       = $$(TONATIUH_ROOT)/bin/release/plugins/MaterialAngleDependent
}
