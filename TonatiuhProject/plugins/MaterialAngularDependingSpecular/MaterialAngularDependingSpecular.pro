...
RESOURCES += src/MaterialAngularDependingSpecular.qrc

TARGET        = MaterialAngularDependingSpecular
 
CONFIG(debug, debug|release) {
    DESTDIR       = $$(TONATIUH_ROOT)/bin/debug/plugins/MaterialAngularDependingSpecular    
    unix {
    ...
    DESTDIR       = $$(TONATIUH_ROOT)/bin/release/plugins/MaterialAngularDependingSpecular
}
