...
#ifndef MaterialAngularDependingSpecular_H_
#define MaterialAngularDependingSpecular_H_
...
class MaterialAngularDependingSpecular : public TMaterial
{
	SO_NODE_HEADER(MaterialAngularDependingSpecular);
...
public:
	...
	MaterialAngularDependingSpecular( );
	...
	trt::TONATIUH_REAL reflectivityCoef;
...
protected:
   	virtual ~MaterialAngularDependingSpecular();
...
#endif /*MaterialAngularDependingSpecular_H_*/
