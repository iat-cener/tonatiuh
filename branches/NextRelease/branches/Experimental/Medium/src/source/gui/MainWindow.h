...
public slots:
	...
	void on_actionDefineMedium_triggered();
    ...
    void parameterModified( const QStringList& oldValueList, SoNode* coinNode, QString coinPart );
...
private:
	...
	void LoadMediumPlugin( QObject* plugin );
	...
	QVector< TMediumFactory* > m_TMediumFactoryList;
