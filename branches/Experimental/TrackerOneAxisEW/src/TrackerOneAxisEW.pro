...
RESOURCES += TrackerOneAxisEW.qrc


DESTDIR       = $$(TONATIUH_ROOT)/plugins/TrackerOneAxisEW
TARGET        = TrackerOneAxisEW

contains(TEMPLATE,lib) {  
	CONFIG(debug, debug|release) {
		INCLUDEPATH += $$(TDE_ROOT)/local/include
		DESTDIR       = $$(TONATIUH_ROOT)/bin/debug/plugins/TrackerOneAxisEW	
		unix {
		...
		DESTDIR       = $$(TONATIUH_ROOT)/bin/release/plugins/TrackerOneAxisEW
	}
}
