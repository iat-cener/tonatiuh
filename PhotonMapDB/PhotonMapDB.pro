...
RESOURCES += src/PhotonMapDB.qrc
TARGET        = PhotonMapDB

LIBS +=-L$${BERKELEYDBDIR}/lib -ldb_cxx 

CONFIG(debug, debug|release) {
	DESTDIR       = $$(TONATIUH_ROOT)/bin/debug/plugins/PhotonMapDB
}
else { 
	DESTDIR       = $$(TONATIUH_ROOT)/bin/release/plugins/PhotonMapDB
}
