...
{
	if( !index.isValid() ) tgf::SevereError( "CmdChangeNodeName called with invalid ModelIndex." );
	InstanceNode* selectedNodeInstance = m_pModel->NodeFromIndex( index );
	if( !selectedNodeInstance ) tgf::SevereError( "CmdChangeNodeName called with invalid node." );
