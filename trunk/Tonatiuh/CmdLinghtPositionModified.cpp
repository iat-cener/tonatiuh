...
{
	Trace trace( "CmdLightPositionModified::CmdLightPositionModified" );
...
{
	Trace trace( "CmdLightKitModified::~CmdLightKitModified" );
}
void CmdLightPositionModified::undo()
{
	Trace trace( "CmdLightKitModified::undo" );
...
{
	Trace trace( "CmdLightKitModified::redo" );
