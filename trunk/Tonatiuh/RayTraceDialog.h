...
public:
	...
	RayTraceDialog( int numRays, double fraction, bool drawPhotons, bool increasePhotonMap, QString resultsFile, QWidget * parent = 0, Qt::WindowFlags f = 0 );
    ~RayTraceDialog();
    ...
    QString GetResultsFile() const { return m_resultsFile; };
    bool DrawPhotons() const {return m_drawPhotons; };
public slots:
	void on_applyPushButton_clicked( bool checked );
	void on_fileDialogButton_clicked( bool checked );
	void saveChanges();
