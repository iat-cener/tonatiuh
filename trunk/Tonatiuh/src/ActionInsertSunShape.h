...
#ifndef ACTIONINSERTSUNSHAPE_H_
#define ACTIONINSERTSUNSHAPE_H_
...
/***********************************************************************//**
 *  Adds insert sunshape action to QT's action list
***************************************************************************/
class ActionInsertSunShape : public QAction
{
	Q_OBJECT

public:
	ActionInsertSunShape( const QString& text, QObject* parent, TSunShapeFactory* pTSunshapeFactory );
	~ActionInsertSunShape();
	
signals:
	void CreateSunShape( TSunShapeFactory* pTSunShapeFactory );
	
public slots:
	void OnActionInsertSunShapeTriggered();
	
private:
	TSunShapeFactory* m_pTSunShapeFactory;
	
};


#endif /*ACTIONINSERTSUNSHAPE_H_*/
