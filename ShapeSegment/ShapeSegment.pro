...
RESOURCES += src/ShapeSegment.qrc


DESTDIR       = $$(TONATIUH_ROOT)/plugins/ShapeSegment
TARGET        = ShapeSegment
...
CONFIG(debug, debug|release) {
	DESTDIR       = $$(TONATIUH_ROOT)/bin/debug/plugins/ShapeSegment	
}
else { 
	DESTDIR       = $$(TONATIUH_ROOT)/bin/release/plugins/ShapeSegment
}
